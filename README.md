...
[![External link newtaber](assets/img/eln-small.png)](assets/img/elns-big.png opens external links in new tab on all sites (at the moment does not support dynamic lists of links such as search results).  
